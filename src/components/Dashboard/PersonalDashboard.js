...
import BudgetList from './FinancialSummary';
...
const PersonalDashboard = ({ token, username }) => {
  const {
    logout,
  ...
  return (
    <div>
      <h1 className="personalbudget">Explore Your Finances</h1>
      <p className="personalbudget">Simplify your financial life with our budgeting platform</p>
  ...
  <ul>
    <li>
      <button onClick={handleBudgetListClick}>Financial Records</button>
    </li>
    <li>
      <button onClick={handleBudgetChartClick}>Budget Analysis Chart</button>
    </li>
    <li>
      <button onClick={handleAddBudgetClick}>New Expense</button>
    </li>
    <li>
      <button onClick={handleAddBudgetCapacityClick}>Budget Customization</button>
    </li>
  </ul>
</nav>
